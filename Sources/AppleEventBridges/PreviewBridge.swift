...
// MARK: PreviewSavo
@objc public enum PreviewSavo : AEKeyword {
...
// MARK: PreviewEnum
@objc public enum PreviewEnum : AEKeyword {
...
// MARK: PreviewGenericMethods
@objc public protocol PreviewGenericMethods {
    @objc optional func closeSaving(_ saving: PreviewSavo, savingIn: URL!) // Close an object.
...
// MARK: PreviewItem
@objc public protocol PreviewItem: SBObjectProtocol, PreviewGenericMethods {
    @objc optional var properties: [AnyHashable : Any] { get } // All of the object's properties.
}
extension SBObject: PreviewItem {}

// MARK: PreviewApplication
@objc public protocol PreviewApplication: SBApplicationProtocol {
    ...
    @objc optional func `open`(_ x: URL!) -> PreviewDocument // Open an object.
    @objc optional func print(_ x: URL!, printDialog: Bool, withProperties: PreviewPrintSettings!) // Print an object.
    @objc optional func quitSaving(_ saving: PreviewSavo) // Quit an application.
}
extension SBApplication: PreviewApplication {}

// MARK: PreviewColor
@objc public protocol PreviewColor: PreviewItem {
}
extension SBObject: PreviewColor {}

// MARK: PreviewDocument
@objc public protocol PreviewDocument: PreviewItem {
...
// MARK: PreviewWindow
@objc public protocol PreviewWindow: PreviewItem {
    @objc optional var bounds: NSRect { get } // The bounding rectangle of the window.
    @objc optional var closeable: Bool { get } // Whether the window has a close box.
    @objc optional var document: PreviewDocument { get } // The document whose contents are being displayed in the window.
...
// MARK: PreviewAttributeRun
@objc public protocol PreviewAttributeRun: PreviewItem {
...
// MARK: PreviewCharacter
@objc public protocol PreviewCharacter: PreviewItem {
    @objc optional var color: NSColor { get } // The color of the first character.
    @objc optional var font: String { get } // The name of the font of the first character.
    @objc optional var size: Int { get } // The size in points of the first character.
    @objc optional func attachments() -> SBElementArray
...
// MARK: PreviewParagraph
@objc public protocol PreviewParagraph: PreviewItem {
    @objc optional var color: NSColor { get } // The color of the first character.
    @objc optional var font: String { get } // The name of the font of the first character.
    @objc optional var size: Int { get } // The size in points of the first character.
    @objc optional func attachments() -> SBElementArray
...
// MARK: PreviewText
@objc public protocol PreviewText: PreviewItem {
    @objc optional var color: NSColor { get } // The color of the first character.
    @objc optional var font: String { get } // The name of the font of the first character.
    @objc optional var size: Int { get } // The size in points of the first character.
    @objc optional func attachments() -> SBElementArray
...
// MARK: PreviewPrintSettings
@objc public protocol PreviewPrintSettings: SBObjectProtocol, PreviewGenericMethods {
    ...
    @objc optional var errorHandling: PreviewEnum { get } // how errors are handled
